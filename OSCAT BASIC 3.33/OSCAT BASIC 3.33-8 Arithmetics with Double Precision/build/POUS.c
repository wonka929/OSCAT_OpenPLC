...
void R2_DIV_body__(R2_DIV *data__) {
  ...
  __SET_VAR(data__->,_R2_DIV,.RX,(__GET_VAR(data__->X,.RX) / __GET_VAR(data__->Y,)));
  __SET_VAR(data__->,_R2_DIV,.R1,(__GET_VAR(data__->X,.R1) / __GET_VAR(data__->Y,)));
...
void R2_ABS_body__(R2_ABS *data__) {
  ...
  if ((__GET_VAR(data__->X,.RX) >= 0.0)) {
    __SET_VAR(data__->,_R2_ABS,.RX,__GET_VAR(data__->X,.RX));
    __SET_VAR(data__->,_R2_ABS,.R1,__GET_VAR(data__->X,.R1));
  } else {
    __SET_VAR(data__->,_R2_ABS,.RX, -(__GET_VAR(data__->X,.RX)));
    __SET_VAR(data__->,_R2_ABS,.R1, -(__GET_VAR(data__->X,.R1)));
  };
...
void R2_MUL_body__(R2_MUL *data__) {
  ...
  __SET_VAR(data__->,_R2_MUL,.RX,(__GET_VAR(data__->X,.RX) * __GET_VAR(data__->Y,)));
  __SET_VAR(data__->,_R2_MUL,.R1,(__GET_VAR(data__->X,.R1) * __GET_VAR(data__->Y,)));
...
void R2_ADD2_init__(R2_ADD2 *data__, BOOL retain) {
  ...
  {
    static const REAL2 temp = {0,0};
    __SET_VAR(data__->,_R2_ADD2,,temp);
  }
}
...
void R2_ADD2_body__(R2_ADD2 *data__) {
  ...
  __SET_VAR(data__->,_R2_ADD2,.R1,(__GET_VAR(data__->X,.R1) + __GET_VAR(data__->Y,.R1)));
  __SET_VAR(data__->,_R2_ADD2,.RX,(__GET_VAR(data__->X,.RX) + __GET_VAR(data__->Y,.RX)));
